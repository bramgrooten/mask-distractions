...
FORMAT_CONFIG = {
    'rl': {
        'train': [
            ...
            ("student_loss", "SALOSS", "float"),  # for SGQN
            ("contrastive_loss", "CONTRALOSS", "float"),  # for SGQN
        ],
        'eval': [
            ('step', 'S', 'int'),
            ('episode_reward', 'ER', 'float'),
            ('episode_reward_test_env', 'ERTEST', 'float'),  # to be replaced by the 3 below
            ...
            ("episode_reward_test_env_distracting_cs", "ERTESTDCS", "float"),
        ]
    }
}
